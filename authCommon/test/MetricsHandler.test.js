...
describe('MetricsHandler', () => {
    ...
    it('should createMetric count type metric without exception', () => {
        expect(() => metricsHandler.createMetric("Unknown_iss", "count", 1, undefined, undefined, true)).to.not.throw();
    });

    it('should createMetric count type metric without exception', () => {
        expect(() => metricsHandler.createMetric("Unknown_iss", "seconds", 1000, undefined, undefined, true)).to.not.throw();
    });
    ...
    it('should createMultipleMetric count type metric without exception', () => {
        ...
        expect(() => metricsHandler.createMultipleMetric(metrics)).to.not.throw();
    });
