...
const { getApiKeyByIndex, getPaAggregateById, getPaAggregationById } = require("../app/dynamoFunctions");
    ...
    AWSMock.mock('DynamoDB.DocumentClient', 'get', (params, callback) => {
      ...
      switch(params.TableName) {
        case 'pn-paAggregations':
          dynamoItem = params.Key["x-pagopa-pn-cx-id"] === "fake" ? undefined : mockPaAggregationFound;
        break;
        case 'pn-aggregates':
          dynamoItem = params.Key.aggregateId === "fake" ? undefined : mockAggregateFound;
        break;
      }
