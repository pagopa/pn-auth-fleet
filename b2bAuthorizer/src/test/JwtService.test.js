...
describe("JwtService tests", function () {
    ...
    it('JWT exteract essential fields', function () {  
        const jwtService = new JwtService(JWT_MAX_AGE_SECONDS_1_YEAR, JWT_CLOCK_TOLERANCE_SECONDS);
        const jwt = 'eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6InRlc3Qta2lkIn0.eyJhdWQiOiJodHRwczovL3Rlc3QtaXNzdWVyLmRldi5ub3RpZmljaGVkaWdpdGFsaS5pdCIsImlzcyI6Imh0dHBzOi8vdGVzdC1pc3N1ZXIuZGV2Lm5vdGlmaWNoZWRpZ2l0YWxpLml0IiwianRpIjoiMTIzMTIzMTIzMTIzMTIiLCJpYXQiOjE3NzM2NTg2OTcsImV4cCI6MTgwNTEwODI5N30.ACffkVQGkfQToQdJ_qXvnpe3CXdCEbX6j5HD2dRgX1BOpDqROLbodaTiEAFZkZtfU5-rDiTrT8mpYYOyj-NeiLYQy3HSc3qIZawdN6aVoVB1JFXxhaP8UsbfR8td0-3uFrJ1BXKUBS8r2oaEHh9yqO7JtLw2ueBa7KX25LNVtD4E0MGn2VUIfj3mfb8KEn8hUnAGJuxJ4TopE11SaNW5dEjEkJcV17r1bgD4yuAMeMNcyKBdZ2EbbAgRgOXiJophupzPOFBPhXJQgAEju5HNbhgRxkB8hIUaSihxCWL7guHJkU7qcu3QXs7aj4SXEaOhAH4yo84IqBhtlAXCUX7twQ';
        const decodedJwt = jwtService.decodeToken(jwt);
